...
public class ConexionMongoService {
    ...
    private static final String POSTGRES_BASE_URL_LOSJOJOS = "http://localhost:8080/Mongo/LosJojos";
    ...
    //PERSONAXES
    public List<LosJojos> listarJojos() {
        try {
            String url = POSTGRES_BASE_URL_LOSJOJOS;
